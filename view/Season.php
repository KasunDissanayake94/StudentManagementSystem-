        ...
        <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation">
            ...
            <div class="navi">
                <ul>
                    ...
                    <li class="active"><a href="../controller/student_controller.php?op=SeasonForms"><i class="fa fa-user" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Season Forms</span></a></li>
            ...
            <div class="user-dashboard">
                <div class="modal-content">
                    <div class="modal-header login-header">
                        <h4 class="modal-title">Season Form</h4>
                    </div>
                    <div class="PDF">
