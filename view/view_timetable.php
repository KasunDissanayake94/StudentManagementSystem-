                ...
                <div class="navi">
                    <ul>
                       ...
                       <!--  <li><a href="../controller/caa_academic_controller.php?op=view_events"><i class="fa fa-calendar" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Events</span></a></li> -->
                        ...
                        <li class="active"><a href="../controller/caa_academic_controller.php?op=view_timetable"><i class="fa fa-calendar-o" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Time Table</span></a></li>
