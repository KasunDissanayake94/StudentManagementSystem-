        ...
        <div class="col-md-2 col-sm-1 hidden-xs display-table-cell v-align box" id="navigation">
            ...
            <div class="navi">
                <ul>
                    ...
                    <li class="active"><a href="../controller/student_controller.php?op=ScolDetails"><i class="fa fa-tasks" aria-hidden="true"></i><span class="hidden-xs hidden-sm">Scholarship Details</span></a></li>
